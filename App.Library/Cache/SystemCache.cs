        ...
        private void _SetCache(string key, object value, TimeSpan? timeout, ExpireType? expireType)
        {
            ...
            else
            {
                if (expireType == ExpireType.Absolute)
                {
                    ...
                    HttpRuntime.Cache.Insert(key, value, null, endTime, System.Web.Caching.Cache.NoSlidingExpiration);
                }
                else
                {
                    HttpRuntime.Cache.Insert(key, value, null, System.Web.Caching.Cache.NoAbsoluteExpiration, timeout.Value);
                }
            }
        }
    }
