...
namespace App.Services
{
    public partial class BaseServices<T> : IBaseServices<T> where T : class, new()
    {
        ...
        #region 方法：单表分页查询 + public List<T> QueryByWherePage(int pageIndex, int pageSize, Expression<Func<T, bool>> whereExpression, string orderbyStr,,ref int pageCount)
        /// <summary>
        /// 单表分页查询
        /// </summary>
        ...
        /// <param name="orderbyStr">排序字段</param>
        /// <returns></returns>
        public List<T> QueryByWherePage(int pageIndex, int pageSize, Expression<Func<T, bool>> whereExpression, string orderbyStr, ref int pageCount)
        {
            return _IBaseRepository.QueryByWherePage(pageIndex, pageSize, whereExpression, orderbyStr, ref pageCount);
        }
        #endregion

        #region 方法：单表分页查询 + public List<T> QueryByWherePage(int pageIndex, int pageSize,,ref int pageCount Expression<Func<T, bool>> whereExpression, string orderbyStr, string whereString = "1=1", object whereObj = null)
        /// <summary>
        /// 单表分页查询
        /// </summary>
        /// <param name="pageIndex">页码</param>
        ...
        /// <param name="whereObj">命令参数对应匿名对象</param>
        /// <returns></returns>
        public List<T> QueryByWherePage(int pageIndex, int pageSize,ref int pageCount, Expression<Func<T, bool>> whereExpression, string orderbyStr, string whereString = "1=1", object whereObj = null)
        {
            return _IBaseRepository.QueryByWherePage(pageIndex, pageSize,ref pageCount, whereExpression, orderbyStr, whereString, whereObj);
        }
        #endregion
